    ...
    public partial class AddStockAndSales : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    COL_ID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FK_STOCK_ID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    COL_TYPE = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    COL_QUANTITY = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FK_TENANT_ID = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    FK_PRODUCT_ID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FK_STOCK_MOVIMENTS = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    COL_QUANTITY = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    COL_RESERVED_QUANTITY = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_STOCK_TB_STOCK_MOVIMENTS_FK_STOCK_MOVIMENTS",
                        column: x => x.FK_STOCK_MOVIMENTS,
                        principalTable: "TB_STOCK_MOVIMENTS",
                        principalColumn: "COL_ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_STOCK_FK_STOCK_MOVIMENTS",
                table: "TB_STOCK",
                column: "FK_STOCK_MOVIMENTS");
